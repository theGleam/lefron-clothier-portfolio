...
function CollectionPage() {
  ...
  window.onscroll = function () {
    ...
    if (currentScrollPos > 70) {
      thisdocument.getElementsByClassName("btn-container").style.position = "fixed";
      if (currentScrollPos > 70 && prevScrollpos > currentScrollPos) {
        thisdocument.getElementsByClassName("btn-container").style.top = "0";
      } else {
        thisdocument.getElementsByClassName("btn-container").style.top = "-50px";
      }
    } else {
