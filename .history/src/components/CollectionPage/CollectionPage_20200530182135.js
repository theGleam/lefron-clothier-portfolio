...
class CollectionPage {
  ...
  `)
    ...
    window.onscroll = function () {
      ...
      this.console.log(this.myRef.current)
      // if (currentScrollPos > 70) {
      //   this.document.getElementsByClassName("btn-container").style.position = "fixed";
      //   if (currentScrollPos > 70 && prevScrollpos > currentScrollPos) {
      //     this.document.getElementsByClassName("btn-container").style.top = "0";
      //   } else {
      //     this.document.getElementsByClassName("btn-container").style.top = "-50px";
      //   }
      // } else {
    ...
    return (<div className="collection-page-container">
      ...
      <div className="card">
        <DescriptionCard longDescription noButton title={getPage().title} description={getPage().description} />
      </div>

      <div className="btn-container" ref={this.myRef}>
